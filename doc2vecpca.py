...
# Step 2: TF-IDF Vectorization with more parameters
...
for params in doc2vec_params:
    ...
    # Step 4: Loop over PCA components and calculate ARI scores with additional parameters
    ...
    for pca_value in pca_values:
        ...
        num_clusters = len(set(ground_truth_encoded)) if len(set(ground_truth_encoded)) < 33 else 33  
